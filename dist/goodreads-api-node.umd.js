(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('oauth'), require('xml2js'), require('request'), require('query-string')) :
	typeof define === 'function' && define.amd ? define(['oauth', 'xml2js', 'request', 'query-string'], factory) :
	(global = global || self, global['goodreads-api-node'] = factory(global.oauth, global.xml2js, global.request, global.queryString));
}(this, function (oauth, xml2js, request, queryString) { 'use strict';
